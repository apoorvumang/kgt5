...
class T5_Dataset(Dataset):
    ...
    def _collate_fn(self, items):
        ...
        inputs_tokenized = self.tokenizer(inputs, padding='max_length', max_length=128, return_tensors="pt")
        outputs_tokenized = self.tokenizer(outputs, padding='max_length', max_length=32, return_tensors="pt")
